...
export default function SignUp() {
  ...
  const handleEmailSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Wait for auth state change to sync to backend and then redirect
  ...
  return (
    <div className="min-h-screen bg-secondary/30 flex items-center justify-center px-4 pt-20 pb-12">
      <motion.div 
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground">Join GenFashionAI and save your style identity.</p>
        </div>
